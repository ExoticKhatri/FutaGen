    ...
    <div className="flex flex-col gap-5 pb-10">
      ...
      <div className="border-b border-white/5 pb-3">
        ...
        <p className="text-[9px] text-white/20 mt-1 normal-case">
          Upload an image generated externally. It will be saved to the library with the current prompt and seed.
        </p>
      </div>
      ...
      <button
        ...
        className="border border-dashed border-white/10 hover:border-accent/30 transition-colors p-6 text-center w-full"
      >
        {preview ? (
          ...
          <div className="flex flex-col items-center gap-2 opacity-25">
            <Upload size={22} />
            <p className="text-[9px] tracking-widest">CLICK_TO_SELECT_IMAGE</p>
          </div>
        )}
      </button>
      ...
      <div className="p-3 bg-white/[0.02] border border-white/5 space-y-2">
        ...
        <div className="flex gap-2">
          <span className="text-[7px] text-accent/40 uppercase w-12 shrink-0">seed</span>
          <span className="text-[8px] text-white/30 normal-case truncate">{state.seed || '—'}</span>
        </div>
        <div className="flex gap-2">
          <span className="text-[7px] text-accent/40 uppercase w-12 shrink-0">prompt</span>
          <span className="text-[8px] text-white/30 normal-case">{imageGenState.prompt ? '✓ ready' : '— none yet'}</span>
        </div>
        <div className="flex gap-2">
          <span className="text-[7px] text-accent/40 uppercase w-12 shrink-0">tags</span>
